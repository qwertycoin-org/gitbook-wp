...
![Difficulty graph when hashrate increased by 800X](<../../../.gitbook/assets/image (2).png>)
...
\
\#3. The #2 makes the situation look bad but the reality isn't. So read on.<br>
...
\
\#12. If there were no attacks or the hash rate was consistent, the network would have released 139.0 million QWC.<br>
